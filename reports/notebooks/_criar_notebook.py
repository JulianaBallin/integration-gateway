...
cells.append(new_code_cell("\n".join([
    ...
    "    ], [0.25, 0.30, 0.45]))",
    "    e.append(H3('8.1 Evidência 06: docker inspect (print obrigatório)'))",
    "    e.append(CodeBlock(",
    ...
    "    ))",
    "    e.append(Nota('A captura do ev06 é horizontal; ela aparece abaixo com borda e legenda.'))",
    "    e += Ev('ev06', 'docker inspect confirmando hardening', max_h=7.2*cm)",
    "    return e",
    "",
    "print('Seções 6-8 OK')",
])))
