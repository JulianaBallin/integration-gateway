...
def transform_payload(payload):
    ...
    # INCIDENT: this version breaks the expected legacy contract.
    # It sends wrong field names, causing internal-api-mock to reject the request.
    legacy_items = []
    ...
    return {
        ...
        "customer_code": str(payload["customer"]["code"]),
        "total_items": total_quantity,
        "items": legacy_items,
        "source_contract": "BROKEN_EXTERNAL_ORDER_V3",
